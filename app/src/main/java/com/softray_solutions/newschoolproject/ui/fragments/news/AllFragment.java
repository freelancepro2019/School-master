...
public class AllFragment extends Fragment implements com.softray_solutions.newschoolproject.ui.fragments.news.NewsView {
    ...
    private com.softray_solutions.newschoolproject.ui.fragments.news.NewsPresenter newsPresenter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newsPresenter = new com.softray_solutions.newschoolproject.ui.fragments.news.NewsPresenter(this);

        newsPresenter.checkLanguage(mainActivity);
    ...
    private void initRecyclerView() {
        mainRecyclerView.setLayoutManager(new LinearLayoutManager(mainActivity));
