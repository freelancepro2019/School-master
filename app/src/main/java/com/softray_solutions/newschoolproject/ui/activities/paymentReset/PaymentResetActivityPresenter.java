...
import com.softray_solutions.newschoolproject.ui.fragments.paymentReset.PaymentReset;

import java.util.Locale;

class PaymentResetActivityPresenter {
    private PaymentResetActivityView view;
    private PrefsInteractor interactor;

    PaymentResetActivityPresenter(PaymentResetActivityView view, AppPrefsHelper appPrefsHelper) {
        this.view = view;
    ...
    public void startFragment() {
        view.setPaymentResetFragment(new PaymentReset(), "PaymentReset");
    }
}
